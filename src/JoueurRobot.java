...
public class JoueurRobot implements Joueur {
	...
	Coord init; // Coord de la premiére Case touché pour le Bateau actuellement
				// pisté
	Coord lastCoord; // Coord de la derniére Case touché pour le Bateau
						// actuellement pisté
				...
				do {
					...
					do {
						...
						case 3:
							...
							break;
						default:
							System.out.println("direction != 0..3");
						}
	...
	public Etat resultatTir(Joueur adv, Etat result, Coord coordTir) {
											...
											// possibilités
		{
			...
			if (couler == true) // si OUI -> COULE
			{
				...
				nombreBatAdv--; // décrémente le nombre de bateaux restant é
								// l'adversaire
			}
		} else
