 ...
 * @author CorentinR
 *
 *         Classe qui contient la méthode main, et qui gére tout le déroulement
...
public class Jeu {
	...
	public static int convertLN(char a) {
		...
		String C = "";
		C += a;
		C = C.toUpperCase(); // permet de prendre en compte minuscule et
								// majuscule (minimise les bugs de saisie
								// clavier)
		a = C.charAt(0);
		switch (a) {
		case 'A':
	 ...
	 * 
	 * 
	 * @return tableau d'entier des paramétres de la partie, taille fixe
	 */
	public static int[] launch() {
		System.out.println(" _______________________________________________ \n" + // titre
																					// d'ouverture
				"|                                               |\n"
				+ "|  é*é  Bienvenue dans la Bataille Navale  é*é  |\n"
				+ "|                                               |\n"
	 ...
	 * partie, suivant les paramétres de l'utilisateur allége le code de
	 ...
	 * @return les deux flottes identiques suivant les paramétres en entrée
	 */
	public static Bateau[][] creationFlotte(int paramRegle, int paramFlotte) {
		...
		{ // les '.' permettent d'éviter la tangence des bateaux et
			...
			if (paramFlotte == 1) {
				...
				Bateau[][] flottes = { { bat1, bat2, bat3, bat4, bat5, bat6, bat7 },
						{ bat12, bat22, bat32, bat42, bat52, bat62, bat72 } };
				return flottes;
			}
			if (paramFlotte == 2) {
				char[][] tab1 = { { ' ', '.', '.', '.', '.', '.', ' ' }, { '.', 'X', 'X', 'X', 'X', 'X', '.' },
			...
			if (paramFlotte == 3) {
				...
				Bateau[][] flottes = { { bat1, bat2, bat3, bat4, bat5, bat6 },
						{ bat12, bat22, bat32, bat42, bat52, bat62 } };
				return flottes;
			}
		}
	...
	/**
	 * Gére un tour de partie complet, se déroulant comme suit : *Incrémentation
	 ...
	 * SI victoire -> return *Deuxiéme joueur : idem
	 * 
	 * @param j1
	...
	/**
	 * Méthode main : gére tout le déroulement du jeu : * intro et paramétrage +
	...
	public static void main(String args[]) {
		...
		if (param[0] == 2) {
			...
			do {
				...
				System.out.println(
						"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
				System.out.println("Prét à jouer " + ((JoueurHumain) j1).getName() + "?");
				ready = sc.next().charAt(0);
				vic = tour(j1, j2);
				if (vic == false) {
					System.out.println(
							"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
					System.out.println("Prét à jouer " + ((JoueurHumain) j2).getName() + "?");
					ready = sc.next().charAt(0);
					vic = tour(j2, j1);
				}
			} while (vic == false);
